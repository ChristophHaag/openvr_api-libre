...
class OSVRHMDCompositor : public IVRCompositor
{
private:
...
public:
    ...
    EVRCompositorError WaitGetPoses( VR_ARRAY_COUNT(unRenderPoseArrayCount) TrackedDevicePose_t* pRenderPoseArray, uint32_t unRenderPoseArrayCount,
        ...
        pRenderPoseArray[0].mDeviceToAbsoluteTracking.m[0][3] = m[0][3];
        ...
        pRenderPoseArray[0].mDeviceToAbsoluteTracking.m[1][3] = m[1][3];
...
class OSVRHMDOverlay : public IVROverlay
{
public:
